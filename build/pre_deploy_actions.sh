...
#the following row is LEGACY
#sfdx force:source:deploy -p "force-app/main/default" -c -l RunSpecifiedTests -r "$LIST_OF_FILES_TO_TEST_TRUNC" -u ${SALESFORCE_TARGET_ORG_ALIAS} --loglevel WARN
